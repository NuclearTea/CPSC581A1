$(document).ready(function () {
    ...
    $(".image-container").mousemove(function (event) {
      ...
      // Ensure crosshair stays within image boundaries and doesn't go outside of it
      mouseX = Math.max(0, Math.min(mouseX, image.width() - crosshair.width()));
      mouseY = Math.max(0, Math.min(mouseY, image.height() - crosshair.height()));
